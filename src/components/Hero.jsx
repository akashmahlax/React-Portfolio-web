...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen bg-gradient-to-tl from-gray-300 via-indigo-500 to-purple-300 text-white overflow-hidden">
      ...
      <div className="container mx-auto h-full flex flex-col justify-center items-center text-center px-6">
        ...
        {/*trust button */}
        <motion.div 
            className="px-6 m-2 py-1 bg-green-500 text-black font-semibold rounded-lg shadow-lg hover:bg-green-400 transition-colors duration-200"
            >
          Since 2010
          </motion.div> 
        ...
        >
         <Link
            to="#" 
            className="px-8 my-2 py-3 bg-yellow-500 text-black font-semibold rounded-lg shadow-lg hover:bg-yellow-400 transition-colors duration-200"
